...
export default SocialCards = ({isBanner, title, summary}) => (
  isBanner ? (
    <Helmet>
      ...
      <meta name="twitter:image" content="https://insomnia.rest/images/twitter-promo.png"/>

      <meta property="og:type" content="website"/>
      <meta property="og:title" content={title}/>
      <meta property="og:description" content={summary}/>
      <meta property="og:image" content="https://insomnia.rest/images/twitter-promo.png"/>
    </Helmet>
  ) : (
    <Helmet>
